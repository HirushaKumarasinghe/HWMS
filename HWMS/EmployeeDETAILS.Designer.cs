...
namespace HWMS {
    ...
    public partial class EmployeeDETAILS : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeeRow AddEmployeeRow(string employeeID, string FName, string employeeType, string city, string phone) {
...
namespace HWMS.EmployeeDETAILSTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employee] WHERE (([employeeID] = @Original_employeeID) AND ((@IsNull_FName = 1 AND [FName] IS NULL) OR ([FName] = @Original_FName)) AND ((@IsNull_employeeType = 1 AND [employeeType] IS NULL) OR ([employeeType] = @Original_employeeType)) AND ((@IsNull_city = 1 AND [city] IS NULL) OR ([city] = @Original_city)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([employeeID], [FName], [employeeType], [city], [pho" +
                "ne]) VALUES (@employeeID, @FName, @employeeType, @city, @phone);\r\nSELECT employe" +
                "eID, FName, employeeType, city, phone FROM Employee WHERE (employeeID = @employe" +
                "eID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [employeeID] = @employeeID, [FName] = @FName, [employeeType] = @employeeType, [city] = @city, [phone] = @phone WHERE (([employeeID] = @Original_employeeID) AND ((@IsNull_FName = 1 AND [FName] IS NULL) OR ([FName] = @Original_FName)) AND ((@IsNull_employeeType = 1 AND [employeeType] IS NULL) OR ([employeeType] = @Original_employeeType)) AND ((@IsNull_city = 1 AND [city] IS NULL) OR ([city] = @Original_city)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)));
SELECT employeeID, FName, employeeType, city, phone FROM Employee WHERE (employeeID = @employeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::HWMS.Properties.Settings.Default.HWMSConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT employeeID, FName, employeeType, city, phone FROM dbo.Employee";
        ...
        public virtual int Fill(EmployeeDETAILS.EmployeeDataTable dataTable) {
        ...
        public virtual EmployeeDETAILS.EmployeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            EmployeeDETAILS.EmployeeDataTable dataTable = new EmployeeDETAILS.EmployeeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(EmployeeDETAILS.EmployeeDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(EmployeeDETAILS dataSet) {
        ...
        public virtual int Delete(string Original_employeeID, string Original_FName, string Original_employeeType, string Original_city, string Original_phone) {
        ...
        public virtual int Insert(string employeeID, string FName, string employeeType, string city, string phone) {
            if ((employeeID == null)) {
        ...
        public virtual int Update(string employeeID, string FName, string employeeType, string city, string phone, string Original_employeeID, string Original_FName, string Original_employeeType, string Original_city, string Original_phone) {
            if ((employeeID == null)) {
                throw new global::System.ArgumentNullException("employeeID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FName, string employeeType, string city, string phone, string Original_employeeID, string Original_FName, string Original_employeeType, string Original_city, string Original_phone) {
            return this.Update(Original_employeeID, FName, employeeType, city, phone, Original_employeeID, Original_FName, Original_employeeType, Original_city, Original_phone);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateUpdatedRows(EmployeeDETAILS dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._employeeTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateInsertedRows(EmployeeDETAILS dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._employeeTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateDeletedRows(EmployeeDETAILS dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._employeeTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual int UpdateAll(EmployeeDETAILS dataSet) {
            if ((dataSet == null)) {
